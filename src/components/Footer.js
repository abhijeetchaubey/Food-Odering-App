        ...
        <div className="bg-slate-800 p-4 pt-10">
            <section className="flex flex-col md:flex-row justify-between p-4 border-b border-gray-700 align-middle mx-auto text-center md:text-left md:h-full">
                ...
                <div className="flex justify-center md:justify-start space-x-4 ">
                    <SocialIcon className="text-reset" network="github" url="https://github.com/abhijeetchaubey" bgColor="gray" target="_blank" />
                    <SocialIcon className="text-reset" network="instagram" url="https://www.instagram.com/abhijeetchaube_/?hl=en" bgColor="gray"target="_blank" />
                    <SocialIcon className="text-reset" network="twitter" url="https://x.com/abhijeetcha10?t=7fFKgnJo7m6vwjCgabogfQ&s=09" bgColor="gray" target="_blank"/>
                    <SocialIcon className="text-reset" network="linkedin" url="https://www.linkedin.com/in/abhijeet-chaube-708683285?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" bgColor="gray" target="_blank" />
                </div>
            </section>
